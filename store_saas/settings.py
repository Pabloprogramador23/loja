"""
Django settings for store_saas project.
...
WSGI_APPLICATION = 'store_saas.wsgi.application'
ASGI_APPLICATION = 'store_saas.asgi.application'
...
REVERSA_TESTING = config('REVERSA_TESTING', default=False, cast=bool)

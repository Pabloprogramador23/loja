...
class Cart:
    ...
    def add(self, product, quantity=1, override_quantity=False):
        ...
        print(f"DEBUG CART: Add product {product_id}, qty={quantity}, override={override_quantity}")
        print(f"DEBUG CART BEFORE: {self.cart}")
        ...
        print(f"DEBUG CART AFTER: {self.cart}")
        self.save()
    ...
    def total_items(self):
        ...
        print(f"DEBUG TOTAL_ITEMS: {count} (from {self.cart})")
        return count
